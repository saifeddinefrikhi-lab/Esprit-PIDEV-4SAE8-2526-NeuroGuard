...
class PatientAlertControllerTest {
    ...
    @Test
        @DisplayName("Should return an empty list when no alerts are available")
        void testGetMyAlerts_EmptyList() throws Exception {
        when(alertService.getAlertsForPatient(2L, 2L, "PATIENT")).thenReturn(List.of());
