  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        path: 'admin/products',
        loadComponent: () =>
          import('./Back-office/pages/product-list.component/product-list.component').then((c) => c.ProductListComponent)
      },
      {
        path: 'admin/orders',
        loadComponent: () =>
          import('./Back-office/pages/order-list.component/order-list.component').then((c) => c.OrderListComponent)
      },
      {
        path: 'admin/deliveries',
        loadComponent: () =>
          import('./Back-office/pages/delivery-list.component/delivery-list.component').then((c) => c.DeliveryListComponent)
      },
