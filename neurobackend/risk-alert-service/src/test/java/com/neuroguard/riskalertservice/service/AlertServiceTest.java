...
class AlertServiceTest {
    ...
    void setUp() {
        ...
        caregiver = new UserDto();
        caregiver.setId(2L);
        caregiver.setFirstName("Jane");
        caregiver.setLastName("Care");
        caregiver.setRole("CAREGIVER");

        provider = new UserDto();
        provider.setId(3L);
        ...
        historySummary.setMedicationAllergies(null);
        historySummary.setEnvironmentalAllergies(null);
        historySummary.setFoodAllergies(null);
    ...
    void testGenerateAlertsForAllPatients_Success() {
        ...
        when(medicalHistoryProviderClient.getMedicalHistoryByPatientId(1L)).thenReturn(historySummary);
    ...
    void testCreateAlert_PatientNotFoundThrows() {
        ...
        RuntimeException exception = assertThrows(RuntimeException.class,
                () -> alertService.createAlert(request, 3L));
